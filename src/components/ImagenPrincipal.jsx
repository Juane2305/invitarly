export const ImagenPrincipal = () => {
  return (
    <div className="bg-fondo-inicio h-screen w-full bg-cover bg-no-repeat bg-bottom flex flex-col justify-center items-center">
        <h1 className="text-white text-4xl font-bold italic text-center">INVITACIONES INOLVIDABLES</h1>
        ...
        <a href="#invitaciones"><button className="mt-8 py-4 px-6 rounded-full border-4 text-lg font-semibold text-white hover:text-gray-900 hover:bg-slate-50 hover:transition">Ver diseños</button></a>
    </div>
  )
}
